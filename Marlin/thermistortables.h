...
/* 32, 33 by miniFactory, the product info is probably wrong? Check if they can be verified somewhere, since they're different from any other table. */

#if (THERMISTORHEATER_0 == 32) || (THERMISTORHEATER_1 == 32) || (THERMISTORHEATER_2 == 32) || (THERMISTORBED == 32) // 100k Epcos thermistor
const short temptable_32[][2] PROGMEM = {
    {1*OVERSAMPLENR, 500},
...
#if (THERMISTORHEATER_0 == 33) || (THERMISTORHEATER_1 == 33) || (THERMISTORHEATER_2 == 33) || (THERMISTORBED == 33) // 100k Honeywell 135-104LAG-J01
const short temptable_33[][2] PROGMEM = {
   {1*OVERSAMPLENR,930},
{10*OVERSAMPLENR,375},
{12*OVERSAMPLENR,365},
{14*OVERSAMPLENR,355},
